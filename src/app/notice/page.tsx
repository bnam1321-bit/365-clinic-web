...
const feeData: FeeItem[] = [
    ...
    { category: "제증명 수수료", subCategory: "건강진단서", name: "기숙사제출용 건강진단서", price: "35,000 원" },
    { category: "제증명 수수료", subCategory: "건강진단서", name: "기숙사제출용 건강진단서 (흉부 엑스레이만)", price: "25,000 원" },
    { category: "제증명 수수료", subCategory: "건강진단서", name: "마약검사 건강진단서", price: "25,000 원" },
    { category: "제증명 수수료", subCategory: "건강진단서", name: "면허신청용 진단서", price: "35,000 원" },
    { category: "제증명 수수료", subCategory: "건강진단서", name: "요양원입소용 진단서", price: "35,000 원" },
