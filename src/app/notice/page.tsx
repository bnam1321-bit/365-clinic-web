...
const feeData: FeeItem[] = [
    ...
    { category: "검사료", subCategory: "내시경 검사", name: "대장 수면관리료", price: "80,000 원" },
    ...
    { category: "예방접종", subCategory: "예방 접종료", name: "인플루엔자 (독감)", detail: "3가", price: "30,000 원" },
    ...
    { category: "예방접종", subCategory: "예방 접종료", name: "A형 간염", detail: "아박심", price: "80,000 원" },
    { category: "예방접종", subCategory: "예방 접종료", name: "B형 간염", detail: "유박스", price: "30,000 원" },

    // 4. 치료료 (도수 & 증식)
    { category: "치료료", subCategory: "도수 치료", name: "도수치료", price: "50,000 원" },
    { category: "치료료", subCategory: "증식 치료", name: "인대증식 (사지관절)", price: "50,000 ~ 100,000 원" },
    { category: "치료료", subCategory: "증식 치료", name: "인대증식 (척추부위)", price: "50,000 ~ 100,000 원" },
    ...
    { category: "제증명 수수료", subCategory: "진단서", name: "영문 일반 진단서", price: "10,000 원" },
    ...
    { category: "제증명 수수료", subCategory: "건강진단서", name: "기숙사제출용 건강진단서", detail: "흉부 엑스레이 검사만", price: "25,000 원" },
    { category: "제증명 수수료", subCategory: "건강진단서", name: "마약검사 건강진단서", price: "30,000 원" },
    { category: "제증명 수수료", subCategory: "채용 신체검사서", name: "일반 채용 신체검사서", price: "30,000 원" },
    { category: "제증명 수수료", subCategory: "채용 신체검사서", name: "공무원 채용 신체검사서", price: "40,000 원" },
    { category: "제증명 수수료", subCategory: "확인서", name: "진료 (통원) 확인서", price: "3,000 원" },
    { category: "제증명 수수료", subCategory: "진료기록 사본", name: "진료기록 사본 (1-5매)", price: "1,000 원", note: "매당" },
    { category: "제증명 수수료", subCategory: "진료기록 사본", name: "진료기록 사본 (6매 이상)", price: "100 원", note: "매당" },
    { category: "제증명 수수료", subCategory: "사본 재발급", name: "사본 재발급 (1장)", price: "1,000 원" },
    { category: "제증명 수수료", subCategory: "진료기록 영상", name: "진료기록 영상 (CD)", price: "10,000 원" },
];
...
export default function NoticePage() {
    ...
    // Group items by category for structured rendering when "전체" is selected
            ...
            <div className={styles.noticeContent}>
                ...
                <div className={styles.legalNoticeCard}>
                    ...
                    <p className={styles.legalText}>
                        ...
                        · 게시된 비급여 진료비용은 환자의 증상, 상태 및 진료 조건에 따라 다소 변동될 수 있습니다.<br />
                ...
                <div className={styles.filterSection}>
                    ...
                    <div className={styles.searchBox}>
                        ...
                        <input
                            type="text"
                            placeholder="항목명 검색 (예: 싱그릭스, 초음파, 진단서)"
                            value={searchTerm}
